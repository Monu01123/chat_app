  ...
  return (
    <div className="h-screen pt-20 flex items-center justify-center relative overflow-hidden bg-base-200/50">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden" style={{ perspective: '1000px' }}>
         ...
         {/* Helper for 3D Stacked Icon */}
         {/* We use a simple layering technique: Shadow + Body + Highlight */}
         ...
         <div className="absolute bottom-[20%] right-[5%] animate-float-slow transform-style-3d -rotate-45">
             <div className="relative">
                ...
                <Eye className="w-20 h-20 absolute top-3 left-3 text-black/10 blur-sm" />
                <Eye className="w-20 h-20 absolute top-1.5 left-1.5 text-primary/30" />
                <Eye className="w-20 h-20 drop-shadow-2xl" style={{ stroke: "url(#grad-primary)", strokeWidth: 1.5 }} />
             </div>
         </div>

         {/* Random Decorators with Glass Effect */}
      ...
      <div className="w-full max-w-md bg-base-100/80 backdrop-blur-2xl p-8 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-10 border border-white/20 relative animate-fade-in-up">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-3xl font-bold mt-4 tracking-tighter bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-all duration-300 transform hover:-translate-y-0.5 rounded-xl bg-gradient-to-r from-primary to-secondary border-none" disabled={isLoggingIn}>
              {isLoggingIn ? (
                <>
          ...
          <div className="text-center pt-2">
            <p className="text-base-content/60 text-sm">
              ...
              <Link to="/signup" className="link link-primary font-semibold hover:no-underline relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-primary hover:after:w-full after:transition-all after:duration-300">
                Create account
              </Link>
            </p>
          </div>
